...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy1.setHeightForWidth(self.le_select_discount.sizePolicy().hasHeightForWidth())
        self.le_select_discount.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.btn_academy_point_payment.sizePolicy().hasHeightForWidth())
        self.btn_academy_point_payment.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.le_payment_amount.sizePolicy().hasHeightForWidth())
        self.le_payment_amount.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.le_purchase_amount_num.sizePolicy().hasHeightForWidth())
        self.le_purchase_amount_num.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.le_payment_amount_num.sizePolicy().hasHeightForWidth())
        self.le_payment_amount_num.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.le_discount_amount_num.sizePolicy().hasHeightForWidth())
        self.le_discount_amount_num.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.le_discount_amount.sizePolicy().hasHeightForWidth())
        self.le_discount_amount.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.le_purchase_amount.sizePolicy().hasHeightForWidth())
        self.le_purchase_amount.setSizePolicy(sizePolicy2)
